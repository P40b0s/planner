...
//             }
//         }
//         logger::debug!("Найдены куки: {:?}", &cookie_jar);
//         // Передача cookie_jar в хендлеры в виде расширения
...
// /// Находим хедер Cookie и перепаковываем все в Arc<CookieJar>
// /// указать для роута:
// /// ```  
// /// Router::new()      
...
//     }
// }
// //TODO надо не мидлвару делать из куков а добавить возможность проверки сессии в auth_middleware если сессия мертва то удалить и вернуть unauthorized
...
//         Self(CookieJar::new())
//     }
//     pub fn wrap(jar: CookieJar) -> Self
//     {
//         Self(jar)
//     }
